...
//	add_action('uamp/template/end', 'uamp_uamp_template_end');
	...
	function uamp_set_menu_walker( $args ) {
		...
		if ( ! has_nav_menu( $args['theme_location'] ) ) {
            ...
            if ( apply_filters( 'uamp/template/set-menu-walker', $args['theme_location'] === 'uamp-main-menu', $args ) ) {

                add_theme_support( 'uamp-navigation' );

                $args['walker'] = new UAMP_Nav_Menu_Walker;
            }
	...
	function uamp_template_sidebar(){
	...
	function uamp_custom_css(){
		...
		?>
		<style amp-custom>
			<?php $uamp->load_parts(array('css'));?>
			<?php do_action( 'amp_post_template_css', $uamp ); ?>
		</style>
	<?php }
